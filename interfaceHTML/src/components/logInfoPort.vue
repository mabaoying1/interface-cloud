<template>
  <div v-loading="loading" class="logInfo">
    <div class="head">
      <div class="tab">
        <div class="ul">
          <div class="li" @click="tabOrg(index,item)" :class="index==bingo? 'bingo':''"
               v-for="(item,index) in tab.mechanismDetails"><span>{{item.mechanismName}}</span></div>
        ...
        methods: {
            ...
            async getOrg() {
                let data = {
                    ...
                    mechanismCode: sessionStorage.getItem('mechanismCode'),//  机构ID
                    serviceId: sessionStorage.getItem('serviceID'),//  服务ID
                    ipAddress: sessionStorage.getItem('ipAddress'),//  IP地址
                    port: sessionStorage.getItem('port'),//  端口
                    status: sessionStorage.getItem('status'),//  状态
            ...
            async getService(item) {
                ...
                let data = {
                    ...
                    // "serviceId":null,//'服务ID',
                    "status": this.status==''?sessionStorage.getItem('status'):this.status,//'状态',
