 ...
 */
@Component
public class GetEurekaInfo {

    @Value("${projectNumber}")
    String projectNumber;
    private static final Logger LOGGER = LoggerFactory.getLogger(GetEurekaInfo.class);
    @Resource
...
//            e.printStackTrace();
    ...
    public static void main(String[] args) {
         ...
         */
        doPostOrGet("http://192.168.0.133:9101/register/getServerInfo", "");
    }
}
