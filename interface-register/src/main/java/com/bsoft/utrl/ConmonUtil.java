...
public class ConmonUtil {
    ...
    public Map<String,Object> getDiscount(Map<String, Object> req) {
        ...
        try {
            resultString = HttpClientUtil.doPostJson(httpUrl + "GetRegFeeReduceResult", json.toString());
        }catch(Exception e){
     ...
     * @author
     */
    public void pusPlatform(String service,String MsgVersion, String MsgType, Map<String,Object> Patient,Map<String,Object> OptRegister) {
        try {
            logger.info("开始调用平台" );
            String message = "";
            //拼接平台需要的xml
            ...
            MsgHeader.put("MsgVersion", MsgVersion);

            //获取当前时间
            BSXml.put("MsgHeader", MsgHeader);
            BSXml.put("PatientId", Patient);
            BSXml.put("OptRegister", OptRegister);
